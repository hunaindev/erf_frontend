...
const Financials = () => {
  ...
  const paymentDate = hasTransaction
    ? new Date(subscriptionDetails.created_at).toLocaleString()
    : "";
  const planLabel = hasTransaction
    ? getPlanLabel(subscriptionDetails.plan_id)
    : "";
  const amountLabel = hasTransaction
    ? getAmountLabel(subscriptionDetails.plan_id)
    : "";
